...
# %% auto 0
__all__ = ['HTTP_PROTOCOLS', 'pmap', 'get_code', 'load_catalog', 'pl_norm', 'partition_data_by_year', 'concat_partitions',
           'format_timedelta', 'resample', 'LblDataset', 'get_memory_usage', 'download_file', 'check_fgm',
...
def concat_partitions(partitioned_input) -> pandas.DataFrame:
