...
![Current sheets in the heliosheath: Voyager 1, 2009](https://agupubs.onlinelibrary.wiley.com/cms/asset/912e3fd6-fe07-4ed9-a216-3c7228a2ebd9/jgra21162-fig-0009.png){fig-alt="Hodograms produced by means of a minimum variance analysis for the current sheets associated with the sector boundaries in Figures 8 and 10. (b, d, and f) The value of the component of B along the minimum variance direction (Bm) as a function of time, N. (a, c, and e) The components of B along the intermediate variance direction (Bi) and maximum variance direction (BM)."}
