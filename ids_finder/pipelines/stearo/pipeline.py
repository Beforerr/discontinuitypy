...
# %% ../../../notebooks/11_stereo.ipynb 12
import os
os.environ['SPEDAS_DATA_DIR'] = f"{os.environ['HOME']}/data"
import pyspedas

# %% ../../../notebooks/11_stereo.ipynb 13
...
# %% ../../../notebooks/11_stereo.ipynb 23
import pooch
from pipe import select

# %% ../../../notebooks/11_stereo.ipynb 24
...
# %% ../../../notebooks/11_stereo.ipynb 33
from ...candidates import create_candidate_pipeline

# %% ../../../notebooks/11_stereo.ipynb 34
def create_pipeline(
    sat_id="sta",
    tau="60s",
