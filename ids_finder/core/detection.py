...
# %% auto 0
__all__ = ['INDEX_STD_THRESHOLD', 'INDEX_FLUC_THRESHOLD', 'INDEX_DIFF_THRESHOLD', 'pl_format_time', 'pl_dvec', 'compute_std',
           'compute_combinded_std', 'add_neighbor_std', 'compute_index_std', 'compute_index_fluctuation',
           'compute_index_diff', 'compute_indices', 'filter_indices', 'detect_events']
...
def compute_index_diff(df: pl.DataFrame, tau: timedelta, cols):
...
# %% ../../notebooks/01_ids_detection.ipynb 16
from .. import PARAMS
