...
# %% auto 0
__all__ = ['INDEX_STD_THRESHOLD', 'INDEX_FLUC_THRESHOLD', 'INDEX_DIFF_THRESHOLD', 'pl_format_time', 'compute_std',
           'compute_combinded_std', 'add_neighbor_std', 'compute_index_std', 'compute_index_fluctuation', 'pl_dvec',
